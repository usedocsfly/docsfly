...
import { DocsflyConfig, Doc } from "../types";
...
export function MobileMenu({ config, docs = [] }: MobileMenuProps) {
            ...
            <div className="flex flex-col h-full">
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-6">
                {config.header?.showSearch && docs.length > 0 && (
                  <div>
                    <h3 className="text-sm font-medium mb-3 text-muted-foreground">Search</h3>
                    <Search
                      docs={docs}
                      config={config}
                ...
                {config.versions?.enabled && (
                  <div>
                    <h3 className="text-sm font-medium mb-3 text-muted-foreground">Version</h3>
